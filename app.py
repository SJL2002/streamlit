...
if not os.path.exists(model_path):
    ...
    def predict_stroke_probability(gender, age, hypertension, heart_disease, ever_married, work_type, residence_type,
        ...
        data = pd.DataFrame({
            ...
            'smoking_status_Unknown': [smoking_status_encoded[3]],
        })
    ...
    def main():
        ...
        if st.session_state.page == 'input':
            ...
            st.write('Check the box if you have ever been Married')
            ...
            ever_married_num = 1 if ever_married else 0

            if st.button('Predict'):
                probability = predict_stroke_probability(gender_num, age, hypertension_num, heart_disease_num, ever_married_num, work_type, residence_num,
                                                        avg_glucose_level, bmi, smoking_status)
